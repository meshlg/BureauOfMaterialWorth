...
local strings = {
    ...
    [SI_BMW_SETTING_DELTA_MODE_TOOLTIP] = "С чем сравнивается изменение стоимости внизу окна. «Каждый визит»: с предыдущим открытием ремесленной сумки; значение сохраняется между перезапусками. «Каждую сессию»: с первым открытием после входа в игру или перезагрузки интерфейса; изменение накапливается до выхода из игры или /reloadui. Изменение только цен при том же составе сумки не отображается. Если состав изменился, итог также включает переоценку цен; наведите курсор или нажмите строку, чтобы увидеть разбор.",
    ...
    [SI_BMW_WINDOW_VERSION_DATE] = "Версия аддона 3.2.174352 от 22.07.2026",
    ...
    [SI_BMW_DETAIL_VISIT_DIFF_TITLE] = "Изменения с прошлого визита",
    [SI_BMW_DETAIL_VISIT_DIFF_EMPTY] = "С прошлого визита количество материалов не изменилось.",
    ...
    [SI_BMW_FOOTER_DELTA_TOOLTIP_CLICK] = "Нажмите, чтобы увидеть материалы с изменившимся количеством.",
