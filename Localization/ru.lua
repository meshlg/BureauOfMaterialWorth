...
local strings = {
    ...
    [SI_BMW_WINDOW_VERSION_DATE] = "Версия аддона 3.1.071108 от 22.07.2026",
    ...
    [SI_BMW_FOOTER_GUIDANCE_CHANGES] = "С момента снимка: %s%s золота - открыть изменения",
    ...
    [SI_BMW_MSG_SIGNIFICANT_DELTA] = "Стоимость ремесленной сумки изменилась на %s%s золота (%d%%).",
